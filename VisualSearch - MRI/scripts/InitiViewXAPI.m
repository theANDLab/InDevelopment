...
% Geometry.monitorSize = int32(24);
% Geometry.redHeightOverFloor = int32(0);
% Geometry.stimHeightOverFloor = int32(0);
% Geometry.redInclAngle = int32(20);
% Geometry.redStimDist = int32(0);
% Geometry.redStimDistHeight = int32(-7);
% Geometry.redStimDistDepth = int32(28);
% Geometry.stimX = int32(520);
% Geometry.stimY = int32(325);
% Geometry.redGeometry = int32(1);
% Geometry.setupName = int8('60Hz_EIZO');
% pREDGeometryStruct = libpointer('REDGeometryStruct', Geometry);

% Geometry.monitorSize = int32(0);
% Geometry.redHeightOverFloor = int32(0);
% Geometry.stimHeightOverFloor = int32(0);
% Geometry.redInclAngle = int32(0);
% Geometry.redStimDist = int32(0);
% Geometry.redStimDistHeight = int32(0);
% Geometry.redStimDistDepth = int32(0);
% Geometry.stimX = int32(0);
% Geometry.stimY = int32(0);
% Geometry.redGeometry = int32(0);
% Geometry.setupName = int8('');
% pREDGeometryStruct = libpointer('REDGeometryStruct', Geometry);
